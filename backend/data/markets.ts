...
export const markets: SeedMarket[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sources: [
      ...
      {
        title: 'Pasadena Zoning Code § 17.50',
        url: 'https://www.cityofpasadena.net/planning/zoning-code/',
        sourceType: 'municipal_code',
        publisher: 'City of Pasadena',
        displayOrder: 2,
      },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sources: [
      ...
      {
        title: 'Malibu Municipal Code § 17.68',
        url: 'https://www.malibucity.org/222/Municipal-Code',
        sourceType: 'municipal_code',
        publisher: 'City of Malibu',
        displayOrder: 2,
      },
